...
function gotPoses(results) {
  if(results.length > 0) {
    xcoordinate = results[0].pose.coordinate.x;
    ycoordinate = results[0].pose.coordinate.y;
  }
}
...
function preload() {
  ball_touch_paddel = loadsoud("ball_touch_paddel.wav");
  missed_ball = loadsound("");
}
